// podman_ssh_auth/src/lib.rs

// region: auto_md_to_doc_comments include README.md A //!
//! # podman_ssh_auth
//!
//! **Store and use encrypted the docker hub token with SSH key**  
//! ***version: 0.0.24 date: 2024-04-23 author: [bestia.dev](https://bestia.dev) repository: [GitHub](https://github.com/CRUSTDE-ContainerizedRustDevEnv/podman_ssh_auth)***
//!
...
//!
//! [![Lines in Rust code](https://img.shields.io/badge/Lines_in_Rust-395-green.svg)]()
//! [![Lines in Doc comments](https://img.shields.io/badge/Lines_in_Doc_comments-398-blue.svg)]()
//! [![Lines in Comments](https://img.shields.io/badge/Lines_in_comments-60-purple.svg)]()
//! [![Lines in examples](https://img.shields.io/badge/Lines_in_examples-19-yellow.svg)]()
//! [![Lines in tests](https://img.shields.io/badge/Lines_in_tests-196-orange.svg)]()
//!
